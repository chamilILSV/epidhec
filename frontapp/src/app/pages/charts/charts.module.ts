...
import { TrafficRevealCardComponent } from './echarts/traffic-reveal-card/traffic-reveal-card.component';
import { TrafficBarComponent } from './echarts/traffic-reveal-card/front-side/traffic-bar/traffic-bar.component';
import { TrafficFrontCardComponent } from './echarts/traffic-reveal-card/front-side/traffic-front-card.component';
import { TrafficCardsHeaderComponent } from './echarts/traffic-reveal-card/traffic-cards-header/traffic-cards-header.component';
import { TrafficBackCardComponent } from './echarts/traffic-reveal-card/back-side/traffic-back-card.component';
import { TrafficBarChartComponent } from './echarts/traffic-reveal-card/back-side/traffic-bar-chart.component';
import { MapPresComponent } from './echarts/map-pres/map-pres.component';
...
@NgModule({
  ...
  declarations: [...routedComponents, ...components, MapPresComponent],
})
